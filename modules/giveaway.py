...
async def initiate_giveaway(message):
    if message.author.guild_permissions.administrator:
        msg = "React to this message with the " + EMOJI + "-emoji to be entered into the giveaway!"
        ...
        await message.channel.send("Sorry, you do not have permissions to initiate a giveaway on this server.")
...
async def end_giveaway(message, client_id):
    if message.author.guild_permissions.administrator:
        ...
        w_msg = "**Gongratulations " + mention_str + " you are the winner of the giveaway!** " + EMOJI + EMOJI
        await message.channel.send(w_msg)
    else:
        await message.channel.send("Sorry, you do not have permissions to end a giveaway on this server.")